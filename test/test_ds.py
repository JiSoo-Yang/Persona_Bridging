...
# ============================================================================
# Hugging Face 모델 래퍼 (DeepSeek 전용)
# ============================================================================

class HuggingFaceModelWrapper:
    """
    DeepSeek-LLM-7B 전용 래퍼
    - CPU float32 안전 모드
    - 표준 transformers pipeline 사용
    """
    def __init__(
        self,
        model_name: str,
        ...
        print(f"\n[DeepSeek] Loading {model_name} on {self.device} (mode={self.mode})")

        # DeepSeek tokenizer & model 로드
...
if __name__ == "__main__":
    ...
    # DeepSeek 모델 사용 (7B 베이스 모델)
    TARGET_MODEL = "deepseek-ai/deepseek-llm-7b-base"
