...
# ============================================================================
import os
os.environ["TRANSFORMERS_NO_TORCHVISION"] = "1"  # ✅ torchvision 의존 완전 차단
...
class HuggingFaceModelWrapper:
    ...
    - CPU float32
    - <think>/<analysis>/<reasoning> 등 '태그'만 금지 (일반 문장 금지는 하지 않음)
    ...
    def invoke(self, messages, do_sample: bool = False, temperature: float = 0.0):
        ...
        # 시작부에 붙은 태그/메타 표현만 '가볍게' 제거 (토큰 낭비 최소화)
